...
load("./15_NK/cellchat/SPP/cellchat_list.rdata")
...
pdf("./15_NK/cellchat/SPP/compareInteraction.pdf",width = 6,height = 3)
gg1 + gg2
dev.off()
...
pdf("./15_NK/cellchat/SPP/netVisual_diffInteraction.pdf",width = 8,height = 4)
...
pdf("./15_NK/cellchat/SPP/netVisual_diffInteraction_to_NK.pdf",width = 8,height = 4)
par(mfrow = c(1,2), xpd=TRUE)
...
#> Do heatmap based on a merged object
pdf("./15_NK/cellchat/SPP/netVisual_heatmap.pdf",width = 10,height = 6)
gg1 + gg2
dev.off()
...
pdf("./15_NK/cellchat/SPP/all_to_NK_Cd11b+Cd27-_Klrc2.pdf",width = 10,height = 6)
gg1 + gg2
dev.off()
...
pdf("./15_NK/cellchat/SPP/CCL.pdf",width = 15,height =15)
par(mfrow = c(1,2))
...
pdf("./15_NK/cellchat/SPP/CCL_detail.pdf",width = 7,height = 4)
