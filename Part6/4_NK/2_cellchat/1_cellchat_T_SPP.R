...
scRNA = subset(scRNA,group %in% c("PP_tumor","SPP_tumor"))


co <- c("PP_tumor","SPP_tumor")
...
dir.create("./15_NK/cellchat/SPP")
save(cellchat_list,file = "./15_NK/cellchat/SPP/cellchat_list.rdata")
